...
public class Constants {
    ...
    public static final String UPLOAD_PLAYLIST = "1";
    public static final int REQUEST_ACCOUNT_PICKER = 2;
    public static final int REQUEST_AUTHORIZATION = 3;
    public static final int RESULT_PICK_IMAGE_CROP = 4;
    public static final int RESULT_VIDEO_CAP = 5;
